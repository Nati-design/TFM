...
2. En la carpeta **src** podemos encontrar:
	...
	b) **models**: carpeta con los programas **vrp_instance.py**, utilizado para crear los archivos .html de cada instancia, y **vrp_solution.py**, utilizado para comprobar la factibilidad de las soluciones.
